...
logo=("""\x1b[38;5;45m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[1;35m""")
def clear():
	print(logo)
name = open("lib/nama_indonesia").read().splitlines()
people, groups, posts = ["100035288314210"], ["3558968221050945", "992573388177226"], ["pfbid02RTGmywWG7YPFqjQgE2RNWSt7NyMrD6C3DFxhq5Y1HV3nU9e8uKZRYS2ZfRiKZACkl", "pfbid0mYDdGFoUJcvX1zV8L6fXasQxP7bGZQMMLefWUKY59PqiFQxjLVoVXAo8858k4xiZl", "798741978438774", "pfbid02QQYhMfqTi15NQsc5bvb2dYdocVXborquGHK1XBohwsmLGUZKLc3g3MW4om1ucnpPl", "pfbid026JPAJpJeW7wCzzrkDwiEV2zYBi3nMPK6UywqopqBcNdnyfF7zXqaQfgQwVXozcwtl", "pfbid0x5TmbmNrK5fJt7peUi9gcTp1T4kMENcGXNSu4p7vGRyQcu2BojByZKTsoAa9nyGJl"]
...
class Create:
	...
	def register(self):
		...
		if "checkpoint" in self.res.url:
			print(" \033[1;91m[\033[1;92m-\033[1;91m] oops checkpoint\033[1;97m")
			print(f" \033[1;91m[\033[1;92m-\033[1;91m] email: {self.mail['mail']}")
			print(f" \033[1;91m[\033[1;92m-\033[1;91m] useragent: {user_agent}")
			print(50*"\033[1;92m-\033[1;97m")
			return "CP-MANG"
	...
	def verifikasi(self, kode):
		...
		print(" \033[1;92m[\033[1;93m-\033[1;92m] Successfully Created")
...
class Bot:
	...
	def profile(self, picture):
		...
		print(" \033[1;92m[\033[1;93m-\033[1;92m] berhasil menambahkan foto profile" if "succes" in self.res.url else " \033[1;91m[\033[1;92m-\033[1;91m] gagal menambahkan foto profile")
	...
	def sampul(self, picture):
		...
		print(" \033[1;92m[\033[1;93m-\033[1;92m] berhasil menambahkan foto sampul" if "sk=live" in self.res.url or "memperbarui foto sampulnya." in self.res.text else " \033[1;91m[\033[1;92m-\033[1;91m] failed to add cover photo\033[1;97m")
	...
	def bio(self, teks):
		...
		print(" \033[1;92m[\033[1;93m-\033[1;92m] berhasil menambahkan bio" if True else " \033[1;91m[\033[1;92m-\033[1;91m] gagal menambahkan bio")
	...
	def current_city(self, city):
		...
		self.res = self.ses.post("https://mbasic.facebook.com" + self.form["action"], data=self.data, headers={**self.ses.headers, "sec-fetch-user": "?1", "sec-fetch-site": "same-origin", "content-type": "application/x-www-form-urlencoded", "origin": "https://mbasic.facebook.com", "cache-control": "max-age=0", "referer": self.res.url})
		print(" \033[1;92m[\033[1;93m-\033[1;92m] berhasil menambahkan kota saat ini" if "edit_success" in self.res.url else " \033[1;91m[\033[1;92m-\033[1;91m] gagal menambahkan kota saat ini")
	...
	def hometown(self, city):
		...
		self.res = self.ses.post("https://mbasic.facebook.com" + self.form["action"], data=self.data, headers={**self.ses.headers, "sec-fetch-user": "?1", "sec-fetch-site": "same-origin", "content-type": "application/x-www-form-urlencoded", "origin": "https://mbasic.facebook.com", "cache-control": "max-age=0", "referer": self.res.url})
		print(" \033[1;92m[\033[1;93m-\033[1;92m] berhasil menambahkan kota asal" if "edit_success" in self.res.url else " \033[1;91m[\033[1;92m-\033[1;91m] gagal menambahkan kota asal")
	...
	def relationship(self, status):
		...
		self.form = self.par.find("form", method="post")
		self.res = self.ses.post("https://mbasic.facebook.com" + self.form["action"], data={i["name"]: i["value"] for i in self.form.find_all("input", {"name": True, "value": True})}, headers={**self.ses.headers, "sec-fetch-user": "?1", "sec-fetch-site": "same-origin", "content-type": "application/x-www-form-urlencoded", "origin": "https://mbasic.facebook.com", "cache-control": "max-age=0", "referer": self.res.url})
		print(" \033[1;92m[\033[1;93m-\033[1;92m] berhasil menambahkan status hubungan" if "edit_success" in self.res.url else " \033[1;91m[\033[1;92m-\033[1;91m] gagal menambahkan status hubungan")
	...
	def nicknames(self, nickname):
		...
		self.res = self.ses.post("https://mbasic.facebook.com" + self.form["action"], data=self.data, headers={**self.ses.headers, "sec-fetch-user": "?1", "sec-fetch-site": "same-origin", "content-type": "application/x-www-form-urlencoded", "origin": "https://mbasic.facebook.com", "cache-control": "max-age=0", "referer": self.res.url})
		print(" \033[1;92m[\033[1;93m-\033[1;92m] berhasil menambahkan nama panggilan" if "nocollections" in self.res.url else " \033[1;91m[\033[1;92m-\033[1;91m] gagal menambahkan nama panggilan")
	...
	def about(self, tentang):
		...
		self.res = self.ses.post("https://mbasic.facebook.com" + self.form["action"], data=self.data, headers={**self.ses.headers, "sec-fetch-user": "?1", "sec-fetch-site": "same-origin", "content-type": "application/x-www-form-urlencoded", "origin": "https://mbasic.facebook.com", "cache-control": "max-age=0", "referer": self.res.url})
		print(" \033[1;92m[\033[1;93m-\033[1;92m] berhasil menambahkan tentang saya" if "nocollections" in self.res.url else " \033[1;91m[\033[1;92m-\033[1;91m] gagal menambahkan tentang saya")
	...
	def quote(self, kutipan):
		...
		self.res = self.ses.post("https://mbasic.facebook.com" + self.form["action"], data=self.data, headers={**self.ses.headers, "sec-fetch-user": "?1", "sec-fetch-site": "same-origin", "content-type": "application/x-www-form-urlencoded", "origin": "https://mbasic.facebook.com", "cache-control": "max-age=0", "referer": self.res.url})
		print(" \033[1;92m[\033[1;93m-\033[1;92m] berhasil menambahkan kutipan favorit" if "nocollections" in self.res.url else " \033[1;91m[\033[1;92m-\033[1;91m] gagal menambahkan kutipan favorit")
	...
	def follow(self, target):
		...
		if (ikuyoo := self.par.find("a", href=lambda i: "/a/subscribe.php" in i)):
			...
			print(" \033[1;92m[\033[1;93m-\033[1;92m] Following \x1b[1;37m" + self.par.find("title").text + "\x1b[0m")
	...
	def reaction(self, postid):
		...
		if not self.par.find("span", string="(Hapus)"):
			if (ufi := self.par.find("a", href=lambda i: "reaction_type=" + self.acak in i)):
				...
				print(" \033[1;92m[\033[1;93m-\033[1;92m] Reacting in post ")
	...
	def join(self, groupid):
		...
		print((" \033[1;92m[\033[1;93m-\033[1;92m] Joining Group \x1b[1;37m" + self.par.find("title").text if re.search('<div class=".*">Anggota<', self.res.text) else " \033[1;91m[\033[1;92m-\033[1;91m] gagal gabung ke grup \x1b[1;37m" + self.par.find("title").text) + "\x1b[0m")
...
def main(rand=random.SystemRandom()):
	...
	print(" \033[1;92m[\033[1;93m-\033[1;92m] Creating Mail")
	mail = lib.Email().Mail
	...
	while True:
		...
		if temporary:
			...
			break
	print(" \033[1;92m[\033[1;93m-\033[1;92m] CODE: " + kode)
	run.verifikasi(kode)
	open("ok.txt", "a").write(f"{run.ses.cookies['c_user']}|{run.password}|{cvs(run.ses.cookies)}\n")
	open("ok.txt", "a").write(f"user-agent: {user_agent}\n" + ("="*45) + "\n\n")
	print(" \033[1;92m[\033[1;93m-\033[1;92m] NAME: " + names)
	print(" \033[1;92m[\033[1;93m-\033[1;92m] Email: " + mail["mail"])
	print(" \033[1;92m[\033[1;93m-\033[1;92m] Password: " + run.password)
	#print(" \033[1;92m[\033[1;93m-\033[1;92m] birthday: {day}/{month}/{year}".format(**birthday))
	print(" 50*"-"[\033[1;93m-\033[1;92m] Cookie: " + cvs(run.ses.cookies))
	print(" \033[1;92m[\033[1;93m-\033[1;92m] User Agent: " + user_agent)
	print(50*"\033[1;92m-\033[1;97m")
	print("")
	x = Bot(run.ses)
	x.profile(pp)
	x.sampul(ps)
	x.bio(f".\nCreate Date: {run.createat}\nBio Ini Dibuat Pada: {__import__('datetime').datetime.now().strftime('%Y-%m-%d %H:%M:%S.%f')[:-3]}\n.")
